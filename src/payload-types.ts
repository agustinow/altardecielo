...
export interface Service {
  ...
  title: string;
  /**
   * URL identifier, e.g. "tarot". No spaces or accents.
   */
  slug: string;
  /**
  ...
  modality?: ('online' | 'in-person' | 'both') | null;
  image?: (number | null) | Media;
  /**
   * Accent color of the card on the site.
   */
  accent?: ('violet' | 'rose' | 'gold' | 'teal') | null;
  order?: number | null;
  updatedAt: string;
  createdAt: string;
}
...
export interface SiteSetting {
  ...
  /**
   * With country code, no spaces or symbols. E.g. 5491122334455
   */
